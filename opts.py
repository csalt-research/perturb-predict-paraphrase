...
def parse_opt():
	...
	parser.add_argument('--n_augs', type=int, default=5,
					help='Number of augmentations per unlabeled image')
	...
	parser.add_argument('--knn_file', default='data/unlabeled2017-101-nn-resnet.json',
					help='Path to file containing closest neighbors for each image')
	...
	parser.add_argument('--custom_decoder_enc_drop', type=float, default=0,
		help='Dropout of encoder')
	parser.add_argument('--custom_decoder_dec_drop', type=float, default=0,
		help='Dropout of decoder')
	parser.add_argument('--custom_decoder_bi',action='store_true', help='Bidirectional encoder?')
	
	parser.add_argument('--pretrain_dec', type=str, default='',
		help='Path to pretrained decoder-2')

	parser.add_argument('--custom_decoder_cnn_enc', type= int, default= 4096, help='CNN encoding dimension')
	parser.add_argument('--unlab_batch_size', type= int, default= 96, help='Batch size for unlabelled data')
	parser.add_argument('--fraction', type= float, default= 1, help='Fraction of labelled data')
	parser.add_argument('--labelfile', type= str, default= '100beampreds.txt', help='Captions for unlabelled data')
	parser.add_argument('--obj_dropout', type= float, default= 0, help='Object dropout on labelled data')
	parser.add_argument('--obj_dropout_unlab', type= float, default= 0.5, help='Object dropout on unlabelled data')
