...
if __name__ == "__main__":
  ...
  # python3 scripts/prepro_labels.py --input_json data/splits/0_5/new_dataset.json --output_json data/splits/0_5/cocotalk.json --output_h5 data/splits/0_5/new_cocotalk
